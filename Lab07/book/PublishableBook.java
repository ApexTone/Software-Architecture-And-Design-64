...
public class PublishableBook extends AbstractBook implements Publishable {
    public PublishableBook(String title, List<String> pages) {
        super(title, pages);
    }

    @Override
    public void printToFile() {
        PublishableBook book = this;
